...
- [x] **Test `ArtifactNotFound` message format**
...
- [x] **Test `JavadocNotAvailable` message format**
...
- [x] **Test `SourcesNotAvailable` message format**
  - Write test: Verify message includes coordinates
...
- [x] **Test `ClassNotFound` message format**
...
- [x] **Test `InvalidCoordinates` message format**
...
- [x] **Test `InvalidClassName` message format**
  - Write test: Verify message includes invalid input
...
- [x] **Research Coursier exception types**
...
- [x] **Test non-existent artifact returns `ArtifactNotFound`**
...
- [x] **Test missing javadoc classifier returns `JavadocNotAvailable`**
...
- [x] **Test missing sources classifier returns `SourcesNotAvailable`**
...
- [x] **Test MCP error response for non-existent artifact**
...
- [x] **Test MCP error response for missing javadoc**
...
- [x] **Test server stability after errors**
...
- [x] **Add `JavadocNotAvailable` to `DocumentationError` enum**
...
- [x] **Implement enhanced `ArtifactNotFound` message**
...
- [x] **Implement `JavadocNotAvailable` message**
...
- [x] **Implement enhanced `SourcesNotAvailable` message**
...
- [x] **Update `fetchJar()` to distinguish Coursier errors**
...
- [x] **Update `fetchJavadocJar()` to use `JavadocNotAvailable`**
...
- [x] **Verify `fetchSourcesJar()` uses `SourcesNotAvailable`**
...
- [x] All error messages enhanced with multi-line format
- [x] `JavadocNotAvailable` error type added and working
- [x] Coursier exceptions mapped to correct domain errors
- [x] All tests passing (unit + integration + E2E)
- [ ] Manual testing confirms user-friendly error messages
- [x] Server stable after error scenarios
